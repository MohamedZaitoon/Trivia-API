...
- Delete a question using a `question_id`
- Request Arguments: None
...
- Return a success of operation.
- Sample: `curl  http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{"question": "What is this test?", "answer": "Nothing","difficulty": 1,"category": 1}'`
```json
{
  "success": true
}
